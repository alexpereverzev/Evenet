...
public class RadialSelectorView extends View {
    ...
    private static final int SELECTED_ALPHA = Util.SELECTED_ALPHA;
    private static final int SELECTED_ALPHA_THEME_DARK = Util.SELECTED_ALPHA_THEME_DARK;
    // Alpha level for the line.
    private static final int FULL_ALPHA = Util.FULL_ALPHA;
