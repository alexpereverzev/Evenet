 ...
 */
public class PullToRefreshList  extends ExpandableListView {
    ...
    /*private void init(){
        ...
        headerContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(eu.erikw.R.layout.ptr_header, null);
        header = (RelativeLayout) headerContainer.findViewById(eu.erikw.R.id.ptr_id_header);
        text = (TextView) header.findViewById(eu.erikw.R.id.ptr_id_text);
        lastUpdatedTextView = (TextView) header.findViewById(eu.erikw.R.id.ptr_id_last_updated);
        image = (ImageView) header.findViewById(eu.erikw.R.id.ptr_id_image);
        spinner = (ProgressBar) header.findViewById(eu.erikw.R.id.ptr_id_spinner);

        pullToRefreshText = getContext().getString(eu.erikw.R.string.ptr_pull_to_refresh);
        releaseToRefreshText = getContext().getString(eu.erikw.R.string.ptr_release_to_refresh);
        refreshingText = getContext().getString(eu.erikw.R.string.ptr_refreshing);
        lastUpdatedText = getContext().getString(eu.erikw.R.string.ptr_last_updated);
