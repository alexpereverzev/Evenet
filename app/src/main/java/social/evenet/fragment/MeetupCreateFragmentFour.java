 ...
 */
public class MeetupCreateFragmentFour extends RefreshableFragment implements RadialPickerLayout.OnValueSelectedListener,TimePickerDialog.OnTimeSetListener {
    ...
    private double mMinutesCurrAngle;
    private double mMinutesPrevAngle;
    private double mHoursCurrAngle;
    ...
    public static Fragment getMeetupCreateFragmetSecond(Bundle b) {
        MeetupCreateFragmentFour fragment = new MeetupCreateFragmentFour();
        fragment.setArguments(b);
        return fragment;
    }

    public MeetupCreateFragmentFour() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_create_meetup_four, container, false);
        ...
        hour = (ImageView) v.findViewById(R.id.hour);
        disable=(ImageView) v.findViewById(R.id.disable);

        disable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.content_meetup, MeetupCreateFragmentThrid.getMeetupCreateFragmetSecond(getArguments())).commit();
            }
        });

       time=(AccessibleTextView) v.findViewById(R.id.include_content).findViewById(R.id.hours);

        minute=(AccessibleTextView) v.findViewById(R.id.include_content).findViewById(R.id.minutes);

       ampm=(TextView) v.findViewById(R.id.include_content).findViewById(R.id.ampm_label);
       ampm.setText("AM");
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                b.putString("time",time.getText().toString()+" : "+minute.getText().toString());
                b.putString("hour",time.getText().toString());
                b.putString("minute", minute.getText().toString());
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.content_meetup, MeetupCreateFragmentFive.getMeetupCreateFragmetFive(b)).commit();
            }
        });

        mAmPmHitspace = v.findViewById(R.id.ampm_hitspace);
        mHourView = (TextView) v.findViewById(R.id.hours);
        mHourView.setOnKeyListener(keyboardListener);
        mHourSpaceView = (TextView) v.findViewById(R.id.hour_space);
        mMinuteSpaceView = (TextView) v.findViewById(R.id.minutes_space);
        mMinuteView = (TextView) v.findViewById(R.id.minutes);
        mMinuteView.setOnKeyListener(keyboardListener);
        mAmPmTextView = (TextView) v.findViewById(R.id.ampm_label);
